...
PubSubClient mqttClient(wifiClient);
  ...
  const char* LEAVE_MESSAGE = "APP_LEAVE";
...
if(isConnected){
  ...
  if(state == WAITING_FOR_BUTTON){
    ...
    if(timeCurrentButtonPressed - timePreviousButtonPressed > millisecBetweenButtons){
      ...
      else if(redValue == HIGH && lastYellowValue != HIGH){
      ...
      else if(blueValue == HIGH && lastBlueValue != HIGH){
      ...
      else if(greenValue == HIGH && lastGreenValue != HIGH){
